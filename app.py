...
def show_contact_us():
    ...
    st.markdown("**We’d love to hear from you! Get in touch with our team for support, feedback, or collaboration opportunities.**")
    ...
    with col1:
        ...
        ### 🌟 What We Do
        We are a team passionate about combining **AI and healthcare** to create impactful diagnostic tools that assist doctors and improve patient outcomes.
        """)

    with col2:
        st.markdown("""
        ### 📬 Contact Details
        - **Email:** support@pneumonia-ai.org  
        - **Response Time:** Within 24–48 hours  
        - **Availability:** Monday–Friday, 9 AM – 6 PM IST  
        - **GitHub:** [github.com/pneumonia-ai](https://github.com/pneumonia-ai)  
        - **LinkedIn:** [linkedin.com/company/pneumonia-ai](https://linkedin.com/company/pneumonia-ai)
        """)

    st.markdown("---")
    st.info("Thank you for using our Pneumonia Detection System! Your feedback helps us improve and serve the medical community better. 💙")
